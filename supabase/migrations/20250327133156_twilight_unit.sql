/*
  ...
  1. New Data
    - Test brand user (Nike Marketing)
    - Test creator user (Sarah Johnson)
    - Creator profile with portfolio and banking info
    - Sample creator content (videos, portfolio items)
    
  2. Security
    - Using ON CONFLICT clauses to handle duplicates safely
